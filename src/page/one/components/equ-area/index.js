...
import icon1 from '../../images/other/icon-1.png'
import icon2 from '../../images/other/icon-2.png'
import icon3 from '../../images/other/icon-3.png'
import icon4 from '../../images/other/icon-4.png'
import icon5 from '../../images/other/icon-5.png'
import icon6 from '../../images/other/icon-6.png'
import icon7 from '../../images/other/icon-7.png'
import icon8 from '../../images/other/icon-8.png'
import icon9 from '../../images/other/icon-9.png'
import icon10 from '../../images/other/icon-10.png'
